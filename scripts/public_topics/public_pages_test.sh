#!/bin/bash
##
## A Helper script oriented towards develop pf th epublic_topics page.
##
## Supports a local  web server  accessing the AWS-based  scimma_admin and archive DB's 
##  n.b. access to the prod db's provides more data to understand and develop the layout
##  of the private topics pages.
##
## Note this script supports a "re-do" everything model 
##   Does manage.py
##   Makes a local_settings.py
##
